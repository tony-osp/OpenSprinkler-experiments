/*
  Input handling for sprinkler local UI.
...
connected to Arduino input pins (specific pins assignment is defined in LocalUI.h), analog input is Freetronics-style (multiple buttons
